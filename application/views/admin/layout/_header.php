...
<head>
  ...
  <link href="<?= base_url('assets/mono/'); ?>plugins/DataTables/DataTables-1.10.18/css/jquery.dataTables.min.css" rel="stylesheet" />
  <link href="<?= base_url('assets/mono/'); ?>plugins/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
  <link href="<?= base_url('assets/mono/'); ?>plugins/daterangepicker/daterangepicker.css" rel="stylesheet" />
  <link href="https://cdn.quilljs.com/1.3.6/quill.snow.css" rel="stylesheet">
  <link href="<?= base_url('assets/mono/'); ?>plugins/toaster/toastr.min.css" rel="stylesheet" />
